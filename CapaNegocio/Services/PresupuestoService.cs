...
namespace CapaNegocio.Services
{
    public class PresupuestoService : IPresupuestoService
    {
        ...
        public PresupuestoService(IRepositorio<Presupuesto> repo)
        {
            _repo = repo;
        }
        public Task Actualizar(PresupuestoUpdateDTO presupuesto)
        {
            throw new NotImplementedException();
        }

        public Task Crear(PresupuestoCreateDTO presupuesto)
        {
            throw new NotImplementedException();
        }
